    ...
    <nav className="sticky top-0 z-50 border-b border-border/50 bg-primary/70 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <Link href="/" className="flex items-center gap-3 group shrink-0">
          <div className="relative flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-accent to-blue-700 text-sm font-black text-white shadow-lg shadow-accent/20 transition-transform group-hover:scale-105">
            H
